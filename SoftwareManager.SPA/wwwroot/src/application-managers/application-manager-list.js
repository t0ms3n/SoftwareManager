    ...
    return {
        ...
        execute: function() {
            ApplicationList = (function (_super) {
                ...
                function ApplicationList(applicationManagerService, router) {
                    _super.call(this, "application-managers", router, applicationManagerService);
                ...
                ApplicationList.prototype.activate = function (params) {
                    var _this = this;
                    this.applicationManagerService.getApplicationManagers().then(function (data) {
                        _this.applicationManagers = data;
                    });
                };
                ApplicationList = __decorate([
                    aurelia_framework_1.autoinject(), 
                    __metadata('design:paramtypes', [index_1.ApplicationManagerService, aurelia_router_1.AppRouter])
                ], ApplicationList);
...
//# sourceMappingURL=application-manager-list.js.map